...
public class Display.FiltersView : Gtk.Box {
    ...
    construct {
        ...
        colorblindness_subtitle.get_style_context ().add_class (Granite.STYLE_CLASS_DIM_LABEL);
        ...
        var colorblindness_box = new Gtk.Grid () {
            row_spacing = 6
        };
        colorblindness_box.attach (colorblindness_headerbox, 0, 0, 2, 1);
        colorblindness_box.attach (none_radio, 0, 1, 2, 1);
        colorblindness_box.attach (protanopia_radio, 0, 2);
        colorblindness_box.attach (protanopia_box, 1, 2);
        colorblindness_box.attach (protanopia_hc_radio, 0, 3);
        colorblindness_box.attach (protanopia_hc_box, 1, 3);
        colorblindness_box.attach (deuteranopia_radio, 0, 4);
        colorblindness_box.attach (deuteranopia_box, 1, 4);
        colorblindness_box.attach (deuteranopia_hc_radio, 0, 5);
        colorblindness_box.attach (deuteranopia_hc_box, 1, 5);
        colorblindness_box.attach (tritanopia_radio, 0, 6);
        colorblindness_box.attach (tritanopia_box, 1, 6);
        colorblindness_box.attach (colorblindness_scale, 0, 7, 2, 1);
